        ...
        <el-container>
            ...
            <el-main class="main-center">
                <div style="display: flex; height: 30px; margin-top: 30px; margin-left: 50px;">
                    ...
                    <button v-on:click="AddProject1" style="margin-left: 10px; background-color:royalblue; border-color: aliceblue; color: aliceblue; border-radius: 5px; width: 100px; box-shadow: 0 0 3px #fff;">添加财务</button>
                </div>
                <el-table
                        :data="tableData"
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <select v-model="opera" style="margin-left: 10px; color:lightslategray;">
                                ...
                                <option value="option2">修改信息</option>
                            </select>
