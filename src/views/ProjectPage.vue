        ...
        <el-container>
            ...
            <el-main class="main-center">
                <div style="display: flex; height: 30px; margin-top: 30px; margin-left: 50px;">
                    <label for="projectname" style=" margin-top: 3px;">项目名称</label>
                    <input type="text" id="projectname" v-model="projectname" style="margin-left: 10px; " placeholder="请输入项目名称" />
                    <label for="projectdtl" style="margin-left: 10px; margin-top: 3px;">项目详情</label>
                    <input type="text" id="projectdtl" v-model="projectdtl" style="margin-left: 10px; margin-top: 3px;" placeholder="请输入项目详情" />
                    <select v-model="selected" style="margin-left: 10px; color:lightslategray;">
                        <option disabled value="">请选择项目状态</option>
                        <option value="option1">未开始</option>
                        <option value="option2">进行中</option>
                    ...
                    <input type="text" id="projectdtl" v-model="addname" style="margin-left: 30%; margin-top: 3px; width: 13%;"  placeholder="请输入要添加的项目成员" />
                    <button v-on:click="AddProject1" style="margin-left: 10px; background-color:royalblue; border-color: aliceblue; color: aliceblue; border-radius: 5px; width: 100px; box-shadow: 0 0 3px #fff;">添加项目</button>
                </div>
                <el-table
                        :data="tableData"
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <select v-model="opera" style="margin-left: 10px; color:lightslategray;">
                                ...
                                <option value="option2">添加成员</option>
                                <option value="option3">修改信息</option>
                            </select>
