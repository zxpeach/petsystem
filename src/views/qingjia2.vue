        ...
        <el-container>
            ...
            <el-main class="main-center">
                <div style="display: flex; height: 30px; margin-top: 30px; margin-left: 50px;">
                    <label for="projectname" style=" margin-top: 3px;">用户ID</label>
                    <input type="text" id="projectname" v-model="projectname" style="margin-left: 10px; " placeholder="请输入用户ID" />
                    <select v-model="selected" style="margin-left: 10px; color:lightslategray;">
                        <option disabled value="">请选择状态</option>
                        <option value="option1">未审批</option>
                        <option value="option2">已审批</option>
                    </select>
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <select v-model="opera" style="margin-left: 10px; color:lightslategray;">
                                ...
                                <option value="option1">已批准</option>
                                <option value="option2">未批准</option>
                            </select>
